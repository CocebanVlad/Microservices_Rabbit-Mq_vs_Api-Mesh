...
namespace BubbleSort.RabbitMQClient
{
    internal class Program
    {
        ...
        private static readonly string Queue = "BubbleSort.InputQueue";

        private static readonly BubbleSortService service = new BubbleSortService();
                    ...
                    using (var conn = connFactory.CreateConnection())
                    {
                        using (var ch = conn.CreateModel())
                        {
                            ...
                            consumer.Received += (object sender, BasicDeliverEventArgs e) =>
                            {
                                ...
                                var words = JsonConvert.DeserializeObject<List<string>>(inputJson);
                                var props = ch.CreateBasicProperties();
                                props.CorrelationId = e.BasicProperties.CorrelationId;

                                var outputJson = JsonConvert.SerializeObject(service.Sort(words));
